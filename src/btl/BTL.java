...
public class BTL {
    ...
    {
        String path_1 = "/home/viethoang/IdeaProjects/JavaProject/top10.xlsx";
        String path_2 = "/home/viethoang/IdeaProjects/JavaProject/hose.xlsx";
        String path_3 = "/home/viethoang/IdeaProjects/JavaProject/stock.xlsx";
        topInc.readShortFileExcel(path_1,0);
        topDec.readShortFileExcel(path_1,1);
        topKLGD.readShortFileExcel(path_1,2);
        stock.readColumnsExcel(path_2);
        stock.readFileExcel(path_2);
        
        rfVNINDEX.readFileExcel(path_3,0);
        rfUPCOMINDEX.readFileExcel(path_3,1);
        rfHNXINDEX.readFileExcel(path_3,2);
    }
