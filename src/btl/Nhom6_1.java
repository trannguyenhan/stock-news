...
public class Nhom6_1 extends SentenceGenerator {
    private int max = 2;
    private int min = 1;
//    private int random_int = (int)(Math.random() * (max - min + 1) + min);



    public Nhom6_1(DSChiSo maTang, DSChiSo maGiam, DSChiSo klGD) {
        super(maTang, maGiam,klGD);
    }
